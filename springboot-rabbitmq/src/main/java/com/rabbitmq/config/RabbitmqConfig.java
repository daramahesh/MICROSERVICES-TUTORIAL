...
public class RabbitmqConfig {
    ...
    public static final String JSON_QUEUE = "rabbit_json_queue";
    public static final String JSON_ROUTING_KEY = "rabbit_json_routing_key";
    /*@Bean
    public Queue queue() {
    ...
    public Binding jsonBinding(Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(JSON_ROUTING_KEY);
    }
